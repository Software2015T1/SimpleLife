 ...
 * {@link FragmentAddOther_step1.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentAddOther_step1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentAddOther_step1 extends FragmentAdd_step {

    ArrayList<String> ids;
    ArrayList<String> names;
    ArrayList<String> arduino;

    public static FragmentAddOther_step1 newInstance() {
        FragmentAddOther_step1 fragment = new FragmentAddOther_step1();
        Bundle args = new Bundle();
        return fragment;
    }

    public FragmentAddOther_step1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_add_other_step1, container, false);
        setSpinnerView();
        ImageButton nextButton = (ImageButton) view.findViewById(R.id.ibtnNext_addOther1);
        nextButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                Other appliance = (Other)((Add_OtherActivity)getActivity()).getAppliance();
                Spinner spinner = (Spinner)view.findViewById(R.id.spinner_whichMain_addOther);
    ...
    public void setSpinnerView(){
        ...
        Spinner mainName = (Spinner)view.findViewById(R.id.spinner_whichMain_addOther);
        ...
        Spinner arduinoName = (Spinner)view.findViewById(R.id.spinner_addOther);
